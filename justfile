...
pull-meta:
    ...
    sqlite3 {{DB_DIR}}/series.sqlite "CREATE VIRTUAL TABLE IF NOT EXISTS series_fts USING fts5(title, content='series');INSERT INTO series_fts(series_fts) VALUES('rebuild');"
